...
<script>
	...
	export default {
		...
		methods: {
			getgoods () {
				this.$http.get("/mlh/appapi/silo/eventForH5?categoryId=women&pageIndex=1&timestamp=1533626481070&summary=9c33bbca7fccfe81fcd663df36a8db3a&platform_code=H5").then(res => {
