...
<script>
	...
	export default {
		...
		methods: {
			getgoods () {
				this.$http.get("/mlh/appapi/silo/eventForH5?categoryId=crossborder&pageIndex=1&timestamp=1533542250881&summary=4b63542d7ea875ce63e3452ad9c96543&platform_code=H5").then(res => {
