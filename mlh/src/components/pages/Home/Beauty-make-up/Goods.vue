...
<script>
	...
	export default {
		...
		methods: {
			getgoods () {
				this.$http.get("/mlh/appapi/silo/eventForH5?categoryId=cosmetics&pageIndex=1&timestamp=1533630124527&summary=76cf19997a73e23f9b9af130ea5ee262&platform_code=H5").then(res => {
